{**
 * templates/controllers/grid/users/stageParticipant/form/removeParticipantForm.tpl
 *
...
<form class="pkp_form" id="removeParticipantForm" method="post" action="{url op="updateRemoveParticipant"}" >
	{csrf}
